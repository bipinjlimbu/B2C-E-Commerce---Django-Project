...
from .views.order_view import order_dispatch_view, order_deliver_view, order_confirmed_view, order_cancelled_view
...
urlpatterns = [
    ...
    path('order/dispatch/<int:order_id>/', order_dispatch_view, name='order_dispatch'),
